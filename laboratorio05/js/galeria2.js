...
for(i=0; i<abrirmodal.length;i++){
    abrirmodal[i].addEventListener("click", function(){
        ...
        case "modal1":
            ...
            imagenmodal.setAttribute("src", "img/atardecer-estilo-retrowave_1920x1080_xtrafondos.com.jpg");
        ...
        case "modal2":
            ...
            imagenmodal.setAttribute("src", "img/d841ebe1432212071a12e514f380183a.png");
        ...
        case "modal3":
            ...
            imagenmodal.setAttribute("src", "img/city.jpg");
        ...
        case "modal4":
            ...
            imagenmodal.setAttribute("src", "img/hombre-a-la-luz-de-la-luna-arte-digital_1920x1080_xtrafondos.com.jpg");
